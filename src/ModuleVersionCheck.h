...
#if defined(NET_ModuleVersion) && defined(MODULE_Network_ETS)

    // Change the following 3 lines and adopt to your module names
    #define ModuleVersion_ModuleName "Network"
    #define ModuleVersion_knxprod_h NET_ModuleVersion
    #define ModuleVersion_version_h MODULE_Network_ETS
